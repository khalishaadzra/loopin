            ...
            <div class="w-1/2 bg-[#F9F5EF] p-12">
                ...
                <form action="/signup" method="POST" class="space-y-4">
                    ...
                    <input type="text" name="name" placeholder="Name"
                        class="w-full border-b border-gray-400 bg-transparent focus:outline-none py-2 placeholder-gray-600" required>
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="w-full mt-6 bg-[#A54D4D] text-white py-2 rounded-md hover:bg-[#521018] transition">
                        Create Account
                    </button>
                    ...
                    <!-- Google Button -->
                    <button type="button"
                        class="w-full flex items-center justify-center border border-gray-400 py-2 rounded-md bg-white hover:bg-gray-100 transition">
